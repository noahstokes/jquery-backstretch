...
The minimum width (in pixels) that you would like the image to scale down to. Once this dimension is reached, the image will no longer scale with the browser window resizing.
